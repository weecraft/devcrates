...
AlertDialogBody.displayName = 'AlertDialogHeader'
...
const AlertDialogFooter = ({
  ...
  <div
    className={mergeClass(
      'flex flex-col-reverse tablet:flex-row tablet:justify-end tablet:spsmace-x-2',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={mergeClass('text-lg font-semibold text-balance', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={mergeClass(
      'text-sm text-foreground/60 text-pretty !leading-relaxed',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={mergeClass(buttonVariants({ variant: 'primary' }), className)}
    {...props}
  />
))
